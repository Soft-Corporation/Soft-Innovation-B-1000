...
Public Class Software_Package_Installer
    ...
    Private Sub Label7_Click(sender As Object, e As EventArgs) Handles Label7.Click
        ...
        Timer13.Start()
        download.DownloadFileAsync(New Uri("ftp://SC@192.168.1.22/Soft%20Innovation/So/Ver.txt"), Application.StartupPath & "\Ver2.txt")
    ...
    Private Sub Timer13_Tick(sender As Object, e As EventArgs) Handles Timer13.Tick
        ...
        If Textbox.Text = "0" Then
            ProgressBar1.Show()
            download.DownloadFileAsync(New Uri("ftp://SC@192.168.1.22/Soft%20Innovation/Spi/Spi%20si.exe"), Application.StartupPath & "\Spi.exe")
        End If


        If Textbox.Text = "" Then
            ProgressBar1.Show()
            download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_dceb6271c39247de8f31496a6ff3fe10.zip"), Application.StartupPath & "\Spi.zip")
        End If
    ...
    Private Sub Timer14_Tick(sender As Object, e As EventArgs) Handles Timer14.Tick
        ...
        If ProgressBar1.Value = 100 Then
            If Textbox.Text = "0" Then
                On Error Resume Next
                Process.Start(Application.StartupPath & "\Spi.exe")
                Timer15.Start()
            End If
            If Textbox.Text = "" Then
                Process.Start(Application.StartupPath & "\Spi.zip")
                Timer15.Start()
            End If
        End If
        Timer15.Start()
